...
function MiniNavbar() {
    ...
    const navLinksData = [
        ...
        { label: 'Carreiras', href: '#2' },
        { label: 'Descobrir', href: '#3' },
    ];
...
export const SignInFlowPage = ({ className }) => {
                                ...
                                {step === "email" ? (
                                    ...
                                    >
                                        <div className="space-y-1">
                                            <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Bem-vindo Desenvolvedor</h1>
                                            <p className="text-[1.8rem] text-white/70 font-light">Seu componente de login</p>
                                        </div>
                                        ...
                                        <p className="text-xs text-white/40 pt-10">
                                            Ao criar conta, você concorda com os <Link to="#" className="underline text-white/40 hover:text-white/60 transition-colors">Termos</Link> e <Link to="#" className="underline text-white/40 hover:text-white/60 transition-colors">Privacidade</Link>.
                                        </p>
                                    </motion.div>
                                ) : step === "code" ? (
                                    <motion.div
                                    ...
                                    >
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-[1.25rem] text-white/50 font-light">Por favor, digite-o</p>
                                        </div>
                                    ...
                                    >
                                        <div className="space-y-1">
                                            <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Você entrou!</h1>
                                            <p className="text-[1.25rem] text-white/50 font-light">Bem-vindo</p>
                                        </div>
